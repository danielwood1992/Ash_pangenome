...
base_name="cantata_PG2_12_1.1.$type";

#Results from svim-asm called by mapping hap2 to BATG-1.0
svim_cantata="/data/SBCS-BuggsLab-Ash/DanielWood/PG2_PanGenome/PG2_12_cantata_test/DW-S26.hap2.svim_asm/variants.vcf.filt3.vcf.$type";

#Results from the individual SV calling methods
svim_ont_flye="/data/SBCS-BuggsLab-Ash/DanielWood/PG2_PanGenome/PG2_12_cantata_test/DW-S26.flye.svim_asm/variants.vcf.filt3.vcf.$type";
svim_ont_nextdenovo="/data/SBCS-BuggsLab-Ash/DanielWood/PG2_PanGenome/PG2_12_cantata_test/DW-S26.nextdenovo.svim_asm/variants.vcf.filt3.vcf.$type";
svim_ont_shasta="/data/SBCS-BuggsLab-Ash/DanielWood/PG2_PanGenome/PG2_12_cantata_test/DW-S26.shasta.svim_asm/variants.vcf.filt3.vcf.$type";

sniffles="/data/SBCS-BuggsLab-Ash/DanielWood/PG2_PanGenome/PG2_7_SVCalling/PG2_7_2_sniffles/DW-S26_PGA5.hap1.rmdpq20.bam.hap1.sniffles.filt2.vcf.$type";
cutesv="/data/SBCS-BuggsLab-Ash/DanielWood/PG2_PanGenome/PG2_7_SVCalling/PG2_7_5_cuteSV/DW-S26_PGA5.hap1.rmdpq20.bam.cuteSV.filt2.vcf.$type";
