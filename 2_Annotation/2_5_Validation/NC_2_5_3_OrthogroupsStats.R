rm(list=ls())
#Orthogroups
groups = read.csv("C:/Users/dwo11kg/Orthogroups.Genecounts.PG2_4_5.8.Mar02_1.tsv", sep = "\t", header = T)


head(groups)
head(groups$LR_SR.PG2_4_4_10.2.results.longest.bed.trimmed.aa)
sum(groups$LR_SR.PG2_4_4_10.2.results.longest.bed.trimmed.aa)

nrow(groups[groups$LR_SR.PG2_4_4_10.2.results.longest.bed.trimmed.aa == groups$Total,])
...
batg1.0_outside = sum(groups$LR_SR.PG2_4_4_10.2.results.longest.bed.aa)-nrow(groups[groups$LR_SR.PG2_4_4_10.2.results.longest.bed.trimmed.aa == groups$Total,])
