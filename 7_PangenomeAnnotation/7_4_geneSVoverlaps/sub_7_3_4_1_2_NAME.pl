...
#Identify prefix and suffix of the SVs that contribute to each individuals transformed fasta makeup
...
#The list of individuals used to make each of the transformed fastas.
...
#This is the input OG00001485.bed.0.txt file, which will have a structure like:
#
